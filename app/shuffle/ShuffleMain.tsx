	...
	return (
		<main className="min-h-screen bg-slate-50 p-6 md:p-12">
			<div className="max-w-5xl mx-auto space-y-8">
				...
				{/* 셔플 액션 컨트롤 파트 */}
				<div className="bg-linear-to-br from-emerald-500/80 to-teal-600 rounded-3xl p-8 text-white shadow-xl relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-6">
